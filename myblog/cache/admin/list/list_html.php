  ...
  <div class="panel admin-panel">
    ...
    <div class="padding border-bottom">
      <ul class="search" style="padding-left:10px;">
        <li> <a class="button border-main icon-plus-square-o" href="http://localhost/myblog/index.php?m=admin&c=list&a=add"> 添加内容</a> </li>
    ...
    <table class="table table-hover text-center">
      ...
      <?php foreach($data as $value):?>
        <tr>
          ...
          <td><div class="button-group"> <a class="button border-red" href="http://localhost/myblog/index.php?m=admin&c=list&a=list_list&did=<?=$value['did'];?>" onclick="return del(1,1,1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
        </tr>
   	<?php endforeach;?>
