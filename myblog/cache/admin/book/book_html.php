...
<form method="post" action="http://localhost/myblog/index.php?m=admin&c=book&a=dele">
...
<?php foreach($data as $value):?>     
      <tr>
          <td><input type="checkbox" name="id[]" value="<?=$value['bid'];?>" />
            <?=$value['bid'];?></td>
          ...
          <td><div class="button-group"> <a class="button border-red" href="http://localhost/myblog/index.php?m=admin&c=book&a=delet&id=<?=$value['bid'];?>" onclick="return del(1)"><span class="icon-trash-o"></span> 删除</a> </div></td>
       </tr>
<?php endforeach;?>        
      <tr>
